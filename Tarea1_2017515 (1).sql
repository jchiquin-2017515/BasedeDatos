...
Insert into Vecinos(DPI, nombres, domicilio, fechaNacimiento, sexo)
	values (1567343450101, 'Valentina Lara','14 calle 3-23 zona 10, Guatemala','2005-04-18','F');
Insert into Vecinos(DPI, nombres, domicilio, fechaNacimiento, sexo)
...
Insert into Vecinos(DPI, nombres, domicilio, fechaNacimiento, sexo)
	values (4567890870101, 'Luis Escobar','5 calle 6-67 zona 9, Guatemala','1997-02-20','M');
Insert into Vecinos(DPI, nombres, domicilio, fechaNacimiento, sexo)
	values (9458945870101, 'Maria Jose Calderon','12 calle 4-4 zona 6, Guatemala','2003-09-3','F');
Insert into Vecinos(DPI, nombres, domicilio, fechaNacimiento, sexo)
	values (2356789370101, 'Eduardo Cabrera','17 calle 6-9 zona 11, Guatemala','2001-12-24','M');
...
Insert into Vehiculos(placa, marca, linea, modelo, color, VIN, DPI)
	values ('P 456LVN', 'Toyota', 'Tundra','2015','Negro','4S4VB2K25JG012845','4655325640101');
Insert into Vehiculos(placa, marca, linea, modelo, color, VIN, DPI)
	values ('P 197LKJ', 'Toyota', 'Prius','2015','Rojo','6F6VC5E78NN554341','9573267560101');
Insert into Vehiculos(placa, marca, linea, modelo, color, VIN, DPI)
...
Insert into Vehiculos(placa, marca, linea, modelo, color, VIN, DPI)
	values ('P 104FGN', 'Kia', 'Sorento','2020','Blanco','9K3LM5B11RE235789','5672323560101');
Insert into Vehiculos(placa, marca, linea, modelo, color, VIN, DPI)
...
-- --------------------------- CONSULTAS
-- a) Que muestre en pantalla el registro con mayor edad
Select MAX(2022-year(fechaNacimiento)) as EDAD from Vecinos;

-- b) Que muestre en pantalla el registro con menor edad
Select MIN(2022-year(fechaNacimiento)) as EDAD from Vecinos;

-- c) Que muestre en pantalla cuántos vehículos hay de cada color
Select color as Color, count(*) as 'Vehiculos con este color' from Vehiculos group by color;

-- d) Que muestre en pantalla los vehículos de color ‘rojo’
Select marca as 'Vehiculos de color rojo', color as Color from Vehiculos V where V.color = "Rojo" order by marca;

-- e) Que muestre en pantalla la cantidad de registros que hay en cada entidad
Select count(*) as 'Cantidad de registros en Vecinos' from Vecinos;
Select count(*) as 'Cantidad de registros en Vehiculos' from Vehiculos;